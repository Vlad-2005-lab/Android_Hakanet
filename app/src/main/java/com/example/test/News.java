...
public class News  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton bt = (ImageButton) findViewById(R.id.imageButton31);
    ...
    public void onClick(View view) throws InterruptedException {
        ...
        TextView enter_or_exit = (TextView) findViewById(R.id.enter_or_exit1);
        TextView messenger = (TextView) findViewById(R.id.messenger1);
        TextView profile = (TextView) findViewById(R.id.profile1111);
        if (flag) {
